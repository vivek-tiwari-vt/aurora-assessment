...
DOCKER_HUB_USERNAME="vivektiwari007"
...
if ! docker info | grep -q "Username"; then
    ...
    echo "  docker login -u vivektiwari007"
    echo ""
...
if docker push $IMAGE_NAME; then
    ...
    echo ""
    echo "🐳 Pull command:"
    echo "   docker pull vivektiwari007/aurora-qa-system:latest"
    echo ""
    echo "⚠️  IMPORTANT: Make sure the repository is PUBLIC on Docker Hub:"
    echo "   1. Go to: https://hub.docker.com/r/vivektiwari007/aurora-qa-system/settings"
    ...
    echo "   2. You have permission to push to vivektiwari007/aurora-qa-system"
